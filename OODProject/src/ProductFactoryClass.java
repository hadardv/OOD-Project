...
public class ProductFactoryClass {
    ...
    public static Product createProduct(ProductType type, String product_name, int cost_price, int selling_price, int stock,double weight, Object... extraParams) {
        switch (type) {
            case WEBSITE:
                ...
                return new SoldThroughWebsite(product_name, cost_price, selling_price, stock, priceDollar, destCountry);
 
            case IN_STORE:
                // Assuming no extraParams required for IN_STORE product or you can add as needed
                return new SoldInStore(product_name, cost_price, selling_price, stock,weight);
 
            case WHOLE_SALERS:
                // Assuming no extraParams required for WHOLE_SALERS product or you can add as needed
                return new SoldToWholeSalers(product_name, cost_price, selling_price, stock, weight);
